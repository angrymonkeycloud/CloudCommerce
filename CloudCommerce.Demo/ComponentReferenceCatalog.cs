...
public static class ComponentReferenceCatalog
{
    ...
    [
        ...
        new("payment-selector", "PaymentSelector", "Payment selector", "Checkout", "Provider choice UI that emits a provider name without executing payment logic in markup.", ["Options", "SelectedProvider", "Title", "Description"], ["OnSelected"]),
        ...
        new("booking-selector", "BookingSelector", "Booking selector", "Booking", "Availability and time-slot selection over standalone CloudBooking models.", ["Slots", "Selected", "TimeZoneLabel", "Title"], ["OnSelected"]),
        ...
        new("provider-card", "ProviderCard", "Provider card", "Integration", "Provider capability presentation with honest navigation or explicit selection behavior.", ["Model", "ActionHref", "ActionLabel", "Selected"], ["OnSelected"])
    ];
